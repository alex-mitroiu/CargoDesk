...
const PDF_RENDER_SERVICE_SECRET = process.env.PDF_RENDER_SERVICE_SECRET || "cargoDesk-dev-pdf-render-secret-do-not-use-in-prod";
if (!process.env.PDF_RENDER_SERVICE_SECRET)
  console.warn("⚠  PDF_RENDER_SERVICE_SECRET env var not set — using insecure dev default. Set it (and the same value in the pdf-render service's own env) before deploying.");
