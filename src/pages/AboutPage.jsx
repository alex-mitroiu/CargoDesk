...
const AboutPage = () => {
  ...
  const features = [
    ...
    { icon: "💼", title: "Financials Hub",             desc: "Quotes, Opportunities, Reports, Freight Audit and Credit Overrides share one sidebar group and a hub page of cards with live counts. Each page keeps its own address, and who sees which is unchanged: Credit Overrides for admin, operator and trade manager; Reports for admin, finance access or trade manager." },
