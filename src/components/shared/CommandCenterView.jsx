  ...
  return (
    <svg width={size} height={size} viewBox={`0 0 ${size} ${size}`} style={{ overflow: "visible" }}>
      ...
      <text x={cx} y={cy + 1} textAnchor="middle" dominantBaseline="middle"
        style={{ fontFamily: "monospace", fontSize: 20, fontWeight: 900, fill: TEXT }}>
    ...
    <div style={{ position:"fixed", inset:0, zIndex:9999,
      ...
      <div style={{ width:560, background:S1,
        ...
        <div style={{ padding:"13px 18px", borderBottom:`1px solid ${BD}`,
          ...
          <span style={{ color:CC, fontSize:14, fontWeight:700 }}>⌘</span>
          <input ref={ref} value={q} onChange={e => setQ(e.target.value)} onKeyDown={onKey}
            placeholder="Search commands…"
            style={{ flex:1, background:"none", border:"none", outline:"none",
              fontFamily:"sans-serif", fontSize:15, color:TEXT, caretColor:CC }} />
...
function AiChatPanel() {
  ...
  if (!enabled) return (
    <div style={{ flex:1, display:"flex", flexDirection:"column",
      ...
      <div style={{ fontSize:28, opacity:.12 }}>✦</div>
        ...
        <div style={{ display:"flex", gap:6, alignItems:"flex-end" }}>
          ...
          <button type="button" onClick={send} disabled={loading || !input.trim()}
            style={{ padding:"6px 11px", borderRadius:7, border:"none", flexShrink:0,
              ...
              fontFamily:"monospace", fontSize:14, fontWeight:700, lineHeight:1 }}>↑</button>
        </div>
      </div>
    </>
  );
...
const SLabel = ({ children }) => (
  <div style={{ fontFamily:"monospace", fontSize:18, fontWeight:700, color:MUTED,
    ...
    <div style={{ marginBottom:20, background:S1, border:`1px solid ${BD}`,
      ...
      <div style={{ display:"flex", alignItems:"center", gap:10, padding:"12px 14px 8px" }}>
        ...
        <button type="button"
          ...
          style={{ marginLeft:"auto", fontFamily:"monospace", fontSize:14, color:MUTED,
        ...
        {shown.length === 0 ? (
          ...
          return (
            <div key={t.id} style={{ display:"flex", alignItems:"center", gap:8,
              ...
              <span style={{ fontFamily:"sans-serif", fontSize:16, color:TEXT, flex:1,
    ...
    <div style={{
      ...
      <div style={{ flexShrink:0, display:"flex", alignItems:"center",
        ...
        <div style={{ display:"flex", alignItems:"center", gap:14 }}>
          <span style={{ fontFamily:"monospace", fontSize:20, fontWeight:800, color:CC,
        ...
        <div style={{ display:"flex", gap:8 }}>
          <button type="button" onClick={() => setCmdOpen(true)}
            style={{ padding:"5px 12px", borderRadius:6,
              ...
              cursor:"pointer", fontFamily:"monospace", fontSize:16, color:MUTED,
              transition:"all .15s" }}
            onMouseEnter={e=>{ e.currentTarget.style.borderColor=CC; e.currentTarget.style.color=CC; }}
            onMouseLeave={e=>{ e.currentTarget.style.borderColor=BD; e.currentTarget.style.color=MUTED; }}>
            ⌘K Commands
          ...
          <button type="button" onClick={onExit}
            style={{ padding:"5px 12px", borderRadius:6,
              border:`1px solid ${BD}`, background:"none",
              cursor:"pointer", fontFamily:"sans-serif", fontSize:16, color:MUTED,
              transition:"all .15s" }}
            onMouseEnter={e=>{ e.currentTarget.style.borderColor="#ef4444"; e.currentTarget.style.color="#ef4444"; }}
            onMouseLeave={e=>{ e.currentTarget.style.borderColor=BD; e.currentTarget.style.color=MUTED; }}>
            Exit ✕
      ...
      <div style={{ flex:1, display:"flex", overflow:"hidden", minHeight:0 }}>
        ...
        <div style={{ flex:1, minWidth:0, overflowY:"auto", padding:"18px 22px",
          ...
          <div style={{ display:"grid", gridTemplateColumns:"repeat(5,1fr)", gap:10, marginBottom:20 }}>
            {[
              ...
              const isActive = activeFilter &&
                (k.filter.status ? activeFilter.status === k.filter.status
                  : !activeFilter.status && !k.filter.status);
              return (
              <button key={k.label} type="button"
                onClick={() => setActiveFilter(af =>
                  af && (k.filter.status ? af.status === k.filter.status : !af.status)
                    ? null : k.filter
                )}
                ...
                <div style={{ display:"flex", alignItems:"center", gap:5, marginBottom:5 }}>
                  ...
                  <span style={{ fontFamily:"monospace", fontSize:14, color:`${k.color}${isActive ? "dd" : "88"}`,
                    textTransform:"uppercase", letterSpacing:".12em", fontWeight:700 }}>
                    {k.label}
                  </span>
                  {isActive && <span style={{ marginLeft:"auto", fontFamily:"monospace", fontSize:12,
                    color:k.color, letterSpacing:".08em" }}>✓</span>}
                </div>
                <div style={{ fontFamily:"monospace", fontSize:40, fontWeight:900,
                  color:k.color, lineHeight:1, fontVariantNumeric:"tabular-nums",
                  textShadow:`0 0 16px ${k.color}55` }}>{k.value}</div>
                <div style={{ fontFamily:"sans-serif", fontSize:16, color:MUTED, marginTop:4 }}>{k.sub}</div>
              </button>
              );
            })}
          </div>
          ...
          <div style={{ display:"grid", gridTemplateColumns:"auto 1fr auto", gap:14, marginBottom:20,
            alignItems:"stretch" }}>
                ...
                <div style={{ display:"flex", flexDirection:"column", gap:5 }}>
                  {donutSegs.map(s => (
                    <div key={s.label} style={{ display:"flex", alignItems:"center", gap:6 }}>
                      ...
                      <span style={{ fontFamily:"sans-serif", fontSize:16, color:MUTED }}>{s.label}</span>
                      <span style={{ fontFamily:"monospace", fontSize:18, fontWeight:700, color:TEXT, marginLeft:"auto" }}>{s.value}</span>
                    </div>
                  ))}
                </div>
              </div>
                ...
                {monthlyBookings.map((v, i) => {
                  ...
                  return (
                    <div key={i} style={{ flex:1, display:"flex", flexDirection:"column",
                      ...
                      <span style={{ fontFamily:"monospace", fontSize:14, color: isLast ? CC : MUTED,
                        fontWeight: isLast ? 700 : 400 }}>{v}</span>
                      <div style={{ width:"100%", height:h,
                        background: isLast ? CC : `${CC}33`,
                        borderRadius:"3px 3px 0 0", transition:"height .4s ease" }} />
                      <span style={{ fontFamily:"sans-serif", fontSize:14, color:MUTED }}>{lbl}</span>
                    </div>
                  );
                })}
              </div>
              ...
              {expiringAllocs.length === 0 ? (
                ...
                return (
                  <div key={a.id} style={{ display:"flex", alignItems:"center", gap:8,
                    ...
                    <span style={{ fontFamily:"sans-serif", fontSize:16, color:MUTED, flex:1 }}>
                      {a.pol}›{a.pod}
                    </span>
                    <span style={{ fontFamily:"monospace", fontSize:16, fontWeight:700,
          ...
          <div style={{ display:"grid", gridTemplateColumns:"1fr 1fr", gap:14, marginBottom:20 }}>
            ...
            <div style={{ background:S1, border:`1px solid ${BD}`, borderRadius:9, padding:"14px 16px" }}>
              ...
              {carrierStats.length === 0 ? (
                <div style={{ fontFamily:"sans-serif", fontSize:18, color:MUTED, padding:"8px 0" }}>No data</div>
                ...
                <div key={c.code} style={{ marginBottom:11 }}>
                  ...
                  {c.allocated > 0 && (
                    <div style={{ fontFamily:"sans-serif", fontSize:14, color:MUTED, marginTop:2 }}>
              ...
              {topRoutes.length === 0 ? (
                ...
                <div key={route} style={{ marginBottom:11 }}>
                  <div style={{ display:"flex", alignItems:"baseline", gap:6, marginBottom:4 }}>
                    ...
                    <span style={{ fontFamily:"sans-serif", fontSize:16, color:MUTED }}>shipments</span>
                  </div>
          ...
          <div style={{ display:"flex", alignItems:"center", gap:10, marginBottom:8 }}>
            ...
            <span style={{ fontFamily:"monospace", fontSize:16, color:MUTED }}>
              {recentShipments.length} shown
            </span>
            {activeFilter && (
              <button type="button" onClick={() => setActiveFilter(null)}
                style={{ marginLeft:"auto", fontFamily:"monospace", fontSize:16, color:MUTED,
          ...
          <div style={{ display:"flex", flexDirection:"column", gap:3 }}>
            {recentShipments.length === 0 ? (
              <div style={{ fontFamily:"sans-serif", fontSize:18, color:MUTED, padding:"16px 0" }}>
                No active shipments.
              </div>
              ...
              return (
                <div key={s.id}
                  ...
                  <div style={{ flex:1, fontFamily:"sans-serif", fontSize:16, color:MUTED,
                    overflow:"hidden", textOverflow:"ellipsis", whiteSpace:"nowrap" }}>
                    {s.pol && s.pod ? `${s.pol} → ${s.pod}` : "—"}
                  </div>
                  {s.carrierCode && (
                    <div style={{ fontFamily:"monospace", fontSize:14, padding:"2px 8px",
                  ...
                  {isOD ? (
                    ...
                    <div style={{ fontFamily:"monospace", fontSize:14, color:MUTED, flexShrink:0 }}>
                      {s.etd}
                    </div>
                  ) : null}
                  <div style={{ width:8, height:8, borderRadius:"50%", flexShrink:0,
        ...
        <div style={{ flexShrink:0, width:300,
          ...
          <div style={{ flexShrink:0, padding:"16px 16px 12px",
            ...
            <div style={{ textAlign:"center" }}>
              ...
              <div style={{ fontFamily:"sans-serif", fontSize:14, color:MUTED,
              ...
              return (
                <div key={a.id} style={{ marginBottom:8 }}>
                  <div style={{ display:"flex", justifyContent:"space-between",
                    fontFamily:"monospace", fontSize:16, marginBottom:3 }}>
          ...
          <div style={{ flexShrink:0, borderBottom:`1px solid ${BD}` }}>
            ...
            <div style={{ padding:"10px 14px 8px", borderBottom:`1px solid ${BD}22` }}>
              <div style={{ display:"flex", alignItems:"center", justifyContent:"space-between",
                marginBottom:6 }}>
                <div style={{ fontFamily:"monospace", fontSize:14, color:MUTED,
                  textTransform:"uppercase", letterSpacing:".14em" }}>
                  Weather
                </div>
                <button type="button"
                  onClick={() => setWxInput(v => !v)}
                  style={{ fontFamily:"monospace", fontSize:14, color:MUTED, background:"none",
              ...
              {wxInput ? (
                ...
                <div style={{ display:"flex", alignItems:"center", gap:8 }}>
                  <span style={{ fontSize:20 }}>{weatherIcon(weather.code)}</span>
            ...
            <div style={{ padding:"8px 14px 10px" }}>
              ...
              <div style={{ display:"flex", alignItems:"center", gap:5, marginBottom:6 }}>
                <input value={fxAmt} onChange={e => setFxAmt(e.target.value)}
                  style={{ width:68, background:BG, border:`1px solid ${BD}`, borderRadius:5,
                    padding:"4px 6px", fontFamily:"monospace", fontSize:16, color:TEXT,
                ...
                <select value={fxFrom}
                  ...
                  style={{ background:BG, border:`1px solid ${BD}`, borderRadius:5,
                    padding:"4px 4px", fontFamily:"monospace", fontSize:16, color:TEXT,
                ...
                <button type="button" onClick={swapFx}
                  style={{ padding:"4px 6px", borderRadius:5, border:`1px solid ${BD}`,
                    background:"none", cursor:"pointer", color:CC, fontSize:16,
              ...
              {fxResult !== null && (
                <div style={{ fontFamily:"monospace", fontSize:20, fontWeight:700,
                  ...
                  <span style={{ fontFamily:"sans-serif", fontSize:14, color:MUTED,
