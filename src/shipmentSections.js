...
export const SHIPMENT_SECTIONS = [
  { id: "shp-conditions", suffix: "conditions", pageKey: "shipment-conditions", icon: "📜", label: "Conditions" },
  { id: "shp-parties",    suffix: "parties",    pageKey: "shipment-parties",    icon: "👥", label: "Parties & Offices" },
  { id: "shp-schedules",  suffix: "schedules",  pageKey: "shipment-schedules",  icon: "⚓", label: "Contracts & Schedules" },
  { id: "shp-cargo",      suffix: "containers", pageKey: "shipment-containers", icon: "📦", label: "Cargo" },
  { id: "shp-milestones", suffix: "milestones", pageKey: "shipment-milestones", icon: "⚑",  label: "Milestones & Events" },
  { id: "shp-documents",  suffix: "documents",  pageKey: "shipment-documents",  icon: "📄", label: "Documents" },
];

export const SHIPMENT_SECTIONS_AFTER_ACCOUNTING = [
  { id: "shp-history", suffix: "history", pageKey: "shipment-history", icon: "🕐", label: "History" },
];
